  ...
  return (
    <section className="pt-[100px]">
      <div className="container mx-auto">
        ...
        <div className="pb-12 border-b flex flex-wrap">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 text-center 2xl:px-5 mb-[70px]">
            ...
            <h3 className="font-bold text-xl sm:text-2xl lg:text-xl xl:text-2xl mb-5">
              SaaS Focused
            </h3>
            <p className="text-gray-400 text-base leading-relaxed">
              Deleniti nemo temporibus minima iusto, voluptatem sint ratione
              eveniet maiores nihil maxime repellendus, dolorum dolorem atque
              delectus laborum.
            </p>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 px-4 text-center 2xl:px-5 mb-[70px]">
